...
public enum Ability
{
	...
	ACE_COMMANDER("Ace Commander", "Whee", new PrereqCheck(){
			@Override public boolean meetsPrereq(Race race, Set<Career> careers, Set<Ability> pAbilities, SkillsBundle pSkills, StatsBundle pStats, Context appContext)
	...
	public PrereqCheck getPrereq(){return prereq;}
}
