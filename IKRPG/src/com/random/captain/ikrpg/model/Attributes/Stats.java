...
public class Stats
{
	public static enum Values
	{
		...
		private Values(String pLongName, String pShortName)
		{
	...
	public Stats(int pPhy, int pSpd, int pStr, int pAgi, int pPoi, int pPrw, int pInt, int pArc, int pPer)
	{
		phyBase = pPhy;
		spdBase = pSpd;
		strBase = pStr;
	...
	public boolean addModifier(Modifier modifier, String key)
	{
